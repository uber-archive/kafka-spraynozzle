...
download: kafka-0.7.2-incubating-src.tgz httpcomponents-client-4.3.6-bin.tar.gz jewelcli-0.8.7.jar java-statsd-client-3.1.0 jackson-core-2.5.3 jackson-databind-2.5.3

extract: kafka-0.7.2-incubating-src httpcomponents-client-4.3.6 java-statsd-client-3.1.0 jackson-core-2.5.3 jackson-databind-2.5.3
